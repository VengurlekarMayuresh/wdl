...
const PatientProfilePage = () => {
  ...
  const currentMedsDetailed = useMemo(() => patient?.medications?.current || [], [patient]);
                      ...
                      <div key={idx} className="p-4 border rounded-lg">
                        <div className="flex items-center justify-between mb-2">
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              ...
                              <div className="text-xs text-muted-foreground">{m.frequency ? `${m.frequency}x/day` : (m.dosage || '')}</div>
                            </div>
                          </div>
                        ...
                        {(m.schedule && m.schedule.length > 0) ? (
                          <div className="grid gap-2">
                            {m.schedule.map((row, rdx) => (
                              <div key={rdx} className="flex items-center justify-between text-sm">
                                <div className="flex items-center gap-2">
