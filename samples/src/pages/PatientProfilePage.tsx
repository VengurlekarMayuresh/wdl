...
const PatientProfilePage = () => {
  ...
  const vitalTrends = [
    { label: "Blood Pressure", current: "128/82", trend: "stable", color: "text-yellow-600" },
    { label: "Heart Rate", current: "72 bpm", trend: "good", color: "text-green-600" },
    { label: "Weight", current: "165 lbs", trend: "down", color: "text-green-600" },
    { label: "Blood Sugar", current: "145 mg/dL", trend: "up", color: "text-red-600" }
  ];

  return (
    <div className="min-h-screen bg-gradient-light">
      <Header isAuthenticated={true} userInitial="J" />
              ...
              <div className="flex flex-col lg:flex-row gap-8">
                ...
                <div className="flex flex-col items-center lg:items-start">
                  <div className="relative">
                    <div className="w-32 h-32 bg-gradient-to-br from-primary/20 to-primary-light/20 rounded-full flex items-center justify-center mb-4">
                      ...
                      <div key={result.id} className="flex items-center justify-between p-4 border rounded-lg">
                        <div>
                          ...
                          <div className="text-sm text-muted-foreground">
                            Ordered by {result.doctor} • {result.date}
                          </div>
                        </div>
